...
RSpec.describe Api::V1::Businesses::AnalyticsController, type: :controller do
  describe "Mobile - Analytics API - " do
    ...
    #   post :get_dashboard, params: {business_id: business_users.last, resource: "events", current_time_slot_dates: "2020-11-11", before_current_time_slot_dates: "2020-12-12"}
