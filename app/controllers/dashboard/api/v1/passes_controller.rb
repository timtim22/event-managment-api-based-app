        ...
        @pubnub = Pubnub.new(
          ...
          subscribe_key: ENV['SUBSCRIBE_KEY']
             ...
             #also notify request_user friends
              if @notification = Notification.create(recipient: user, actor: request_user, action: User.get_full_name(request_user) + " has sent you a VIP pass to join their event.", notifiable: @wallet.offer, url: "/admin/#{@wallet.offer.class.name.downcase}s/#{@wallet.offer.id}", notification_type: 'mobile', action_type: 'add_to_wallet') 
