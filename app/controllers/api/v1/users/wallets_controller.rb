  ...
  @expired_passes = []
   ...
   if is_redeemed(pass.id, 'Pass', request_user.id)
          ...
          @redeemed_passes << {
            ...
            validity: get_date_time(pass.event.end_date, pass.event.end_time),
...
def get_tickets
  ...
  @tickets << {
    ...
    event_start_time: get_date_time(wallet.offer.event.start_date, wallet.offer.event.start_time),
