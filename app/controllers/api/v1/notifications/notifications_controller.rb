    ...
    notifications.each do |notification|
      ...
      when "create_event"
        @notifications << {
          ...
          "event_location": remove_slashes(notification.resource.location),
      ...
      when "create_competition"
        ...
        when "create_pass"
          @notifications << {
            ...
            "event_location": remove_slashes(notification.resource.event.location),
        ...
        when "create_interest"
          @notifications << {
            ...
            "event_location": remove_slashes(notification.resource.child_event.location),
            "actor_id": notification.actor_id,
            "actor_image": notification.actor.avatar,
            "notifiable_id": notification.notifiable_id,
            "notifiable_type": notification.notifiable_type,
      ...
      when "add_Competition_to_wallet"
        ...
        when "add_Pass_to_wallet"
          @notifications << {
            ...
            "event_location": remove_slashes(notification.resource.offer.event.location),
