  ...
  def get_map_event_object(event)
     ...
     def get_simple_child_event_object(child_event)
      ...
      e = {
        ...
        "start_date" => get_date_time_mobile(child_event.start_time),
        "end_date" => get_date_time_mobile(child_event.end_time),
        "start_time" => get_date_time_mobile(child_event.start_time),
        "end_time" => get_date_time_mobile(child_event.end_time),
