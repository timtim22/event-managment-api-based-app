...
Rpush.reflect do |on|
  ...
  # on.error do |error|
  # end
  if (!Rpush::Gcm::App.find_by_name("MyGo"))
    app = Rpush::Gcm::App.new
    # let's name this one pushme_droid
    app.name = "MyGo"
    # FCM auth key from firebase project
    app.auth_key = "AAAAPBig7Gw:APA91bEtgupYgor5mTaijX-NcABfPPTpzcBY7DPlCoUpd6TfCpLu2ZwaV1MG4b9YJnGH9qOHM9GuIrHj1qP3YvDKMyO9VpRP7YqoJLf33_FG9W49nGwUfX4gWgzvk69m3bfpuOwG0zpy"
    app.connections = 1
    # save our app in db
    app.save!
end
